        ...
        <Card className="bg-gradient-to-br from-purple-500 to-purple-600 dark:from-purple-600 dark:to-purple-700">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-white opacity-90">USR & ATSM Combined</p>
                <p className="text-3xl font-bold text-white" data-testid="text-usr-atsm-count">{usrAtsmCount.toLocaleString()}</p>
                <p className="text-xs text-white opacity-75">
                  Unauthorized Search Result + Ads Tutorials
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="bg-gradient-to-br from-teal-500 to-teal-600 dark:from-teal-600 dark:to-teal-700">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-white opacity-90">PSSM & PSMP Combined</p>
                <p className="text-3xl font-bold text-white" data-testid="text-pssm-psmp-count">{pssmPsmpCount.toLocaleString()}</p>
                <p className="text-xs text-white opacity-75">
                  Password Sharing - Social Media + Marketplace
                </p>
              </div>
            </div>
          </CardContent>
